      ...
      <div className='w-[100%] h-[12dvh] flex justify-between items-center max-w-[1100px] exsm:flex-col md:flex-row exsm:w-[100%]'>
        <div className='flex w-1/2 exsm:w-full exsm:h-1/2 sm:bg-transparent'>
          <div className='w-[33%] h-full flex items-center justify-center'>
            <img className='w-3/4 h-1/2' src={Icon1} loading='lazy' alt='Icon 1' />
          </div>
          <div className='w-[33%] h-full flex items-center justify-center'>
            <img className='w-3/4 h-1/2' src={Icon2} loading='lazy' alt='Icon 2' />
          </div>
          <div className='w-[33%] h-full flex items-center justify-center'>
            <img className='w-3/4 h-1/2' src={Icon3} loading='lazy' alt='Icon 3' />
          </div>
        </div>
        <div className='flex h-20 w-1/2 exsm:w-full exsm:h-1/2'>
          <div className='w-[33%] h-full flex items-center justify-center '>
            <img className='w-3/4 h-1/2' src={Icon4} loading='lazy' alt='Icon 4' />
          </div>
          <div className='w-[33%] h-full flex items-center justify-center'>
            <img className='w-1/2 h-1/2' src={Icon5} loading='lazy' alt='Icon 5' />
          </div>
          <div className='w-[33%] h-full flex items-center justify-center'>
            <img className='w-1/2 h-1/2' src={Icon6} loading='lazy' alt='Icon 6' />
          </div>
        </div>
      </div>
    </motion.div>
